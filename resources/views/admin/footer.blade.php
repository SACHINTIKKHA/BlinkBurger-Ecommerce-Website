          ...
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#"> Vrindavan Colony </a>
                </li>
                <li class="nav-item">
            ...
            <div class="copyright">
              2026, Made By<i class="fa fa-heart heart text-danger"></i> by
              <a href="http://www.themekita.com">Sachin Tikkha</a>
            </div>
            <div>
              Under the Guidance of
              <a target="_blank" href="https://themewagon.com/">Mr. Rochak Jaitly</a>.
            </div>
          </div>
        </footer>
      </div>
